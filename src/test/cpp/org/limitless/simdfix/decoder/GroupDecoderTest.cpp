...
#include "org/limitless/simdfix/decoder/GroupDecoder.hpp"
...
// A group whose NumInGroup tag is absent reads as empty rather than failing,
// and leaves no scope behind from a previous wrap.
TEST(GroupDecoder, AbsentGroupIsEmpty)
{
    const auto logout = utils::makeSpan(
        "8=FIXT.1.1" SOH "9=84" SOH "35=5" SOH "49=Buyer" SOH "56=Seller" SOH "34=100101" SOH "52=10:11:12.123" SOH
        "627=2" SOH "629=10" SOH "628=12" SOH "629=37" SOH "628=20" SOH "10=211" SOH);
    ...
    group.wrap<9999>();
    EXPECT_EQ(0u, group.count());
    EXPECT_FALSE(group.hasNext());
    const auto scope = field.groupScope();
    EXPECT_EQ(0, scope.begin);
    EXPECT_EQ(static_cast<int32_t>(fields.size()), scope.end);
}
