...
/usr/bin/time -l ./cmake-build-release/SimdFixBenchmark hot   # or cold|getters|groups|all
```
...
(plus 4 warm-up passes for HOT CACHE) and `1 GiB / message length` for COLD.