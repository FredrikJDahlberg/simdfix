...
namespace org::limitless::simdfix::encoder { class DataEncoder; }

namespace org::limitless::simdfix::detail::encoder {
...
class FieldEncoder
{
    friend class org::limitless::simdfix::encoder::DataEncoder;
