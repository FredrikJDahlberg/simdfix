...
// Pins generated code to the simdfix release whose Generator made it: the
// hand-written headers it builds on may change between releases.
static void generateVersionCheck(std::ostream& out)
{
    out << "#include \"org/limitless/simdfix/Version.hpp\"\n\n";
    out << std::format("static_assert(SIMDFIX_VERSION_MAJOR == {} && SIMDFIX_VERSION_MINOR == {} && "
                       "SIMDFIX_VERSION_PATCH == {},\n",
                       SIMDFIX_VERSION_MAJOR, SIMDFIX_VERSION_MINOR, SIMDFIX_VERSION_PATCH);
    out << std::format("              \"generated by the simdfix {} Generator: regenerate these headers with the \"\n"
                       "              \"Generator of the simdfix they are compiled against\");\n\n",
                       SIMDFIX_VERSION);
}
...
int main(int argc, char** argv)
{
    ...
    for (int i = 1; i < argc; ++i)
    {
        ...
        {
            std::println("simdfix Generator {}", SIMDFIX_VERSION);
            return 0;
        }
        else
        {
