...
namespace org::limitless::generator::simdfix {

using limitless::simdfix::detail::Category;
using limitless::simdfix::detail::RecordType;
using limitless::simdfix::detail::Presence;
using limitless::simdfix::MaxGroupDepth;
...
struct DataModel
{
                       ...
                       const RecordType parent, Record& record)
    {
        for (const auto& field : nodes)
        {
            ...
            const auto presence = limitless::simdfix::detail::parse(presenceAttr);
